...
type MetricsInterface interface {
	...
	GetObjectMetric(metricName string, namespace string, objectRef *autoscalingv2beta2.CrossVersionObjectReference, metricSelector labels.Selector)(int64, time.Time, error)
